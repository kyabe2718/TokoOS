...
ata0-master: type=disk, mode=flat, translation=auto, path="$PATH", cylinders=20, heads=2, spt=16, biosdetect=auto, model="Generic 1234"
ata1: enabled=1, ioaddr1=0x170, ioaddr2=0x370, irq=15
ata1-master: type=disk, mode=flat, translation=auto, path="$PATH", cylinders=20, heads=2, spt=16, biosdetect=auto, model="Generic 1234"
ata2: enabled=0
ata3: enabled=0
